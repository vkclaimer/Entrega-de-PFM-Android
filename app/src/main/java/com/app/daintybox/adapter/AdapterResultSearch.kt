...
class AdapterResultSearch(context: Context?, data: ArrayList<DocumentSnapshot>?) : RecyclerView.Adapter<AdapterResultSearch.ViewHolder>(){

    var data: ArrayList<DocumentSnapshot>? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = inflater!!.inflate(R.layout.layout_item_product_search, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: ViewHolder,position: Int) {
        val producto: DocumentSnapshot = data!![position]

        holder.tw_product_name.text = producto.data?.get("name").toString()
        holder.tw_product_description.text = producto.data?.get("description").toString()
        holder.tw_price.text = "$"+producto.data?.get("price").toString()

        val images: ArrayList<String> = producto.data?.get("images") as ArrayList<String>
